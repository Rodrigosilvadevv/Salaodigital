  ...
  if (bookStep === 4) {
    return (
      <div className="min-h-screen bg-white flex flex-col items-center justify-center p-8 text-center">
        ...
        <button onClick={() => { setBookStep(0); setSelectedService(null); setSelectedDate(null); setSelectedTime(null); setClientName(''); setClientPhone(''); }}
          className="text-blue-600 font-bold text-sm">Fazer outro agendamento</button>
      </div>
    );
  }
          ...
          <div className="bg-white mt-4 rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
            <div className="p-4 border-b border-slate-100 flex items-center justify-between">
              <h3 className="font-black text-slate-900 text-sm">
                {bookStep === 1 ? 'Escolha o serviço' : bookStep === 2 ? 'Data e horário' : 'Seus dados'}
              </h3>
                ...
                <div>
                  ...
                  {selectedTime && selectedDate && (
                    <button onClick={() => setBookStep(3)}
                      className="w-full mt-5 py-4 bg-blue-600 text-white rounded-xl font-black text-sm active:scale-95 transition-all">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-blue-50 rounded-xl p-3 flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-[10px] text-slate-500">{selectedDate?.split('-').reverse().join('/')} às {selectedTime}</p>
                    </div>
                  ...
                  <div>
                    ...
                    <input type="tel" value={clientPhone} onChange={e => setClientPhone(e.target.value)} placeholder="(41) 99999-9999"
                      className="w-full bg-slate-50 border-2 border-slate-200 rounded-xl px-4 py-3 text-sm outline-none focus:border-blue-500 transition-colors" />
                  </div>
