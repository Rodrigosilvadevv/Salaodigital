...
const supabaseUrl = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imxsc3dwbWRvZ2V2c25zcmhuc3J3Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzI4NDg0MjksImV4cCI6MjA4ODQyNDQyOX0.6EcebGjxj05dDyKl5l5DKKBtLvkC5w-Var1MEyzxzrY'; 
      ...
      {showPayModal && (
        <div className="fixed inset-0 z-[100] bg-slate-900/90 backdrop-blur-sm flex items-center justify-center p-6">
          <div className="bg-white rounded-3xl p-8 max-w-sm w-full text-center shadow-2xl animate-in zoom-in-95">
            ...
            <p className="text-slate-500 text-sm mb-6">Você atingiu o limite de <b>3 serviços gratuitos</b>. Assine o plano Pro para adicionar mais opções.</p>
            <div className="space-y-3">
              <button 
        ...
        {activeTab === 'services' && (
          <div className="space-y-4">
            <div className="p-4 bg-blue-50 rounded-2xl mb-4">
                <p className="text-xs text-blue-700 font-medium">Selecione os serviços. <br/> 
                <span className="font-bold">{user.plano_ativo ? 'Você tem acesso ilimitado!' : `Plano Grátis: ${user.my_services?.length || 0}/3 serviços usados.`}</span>
                </p>
            </div>
